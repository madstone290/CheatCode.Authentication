using CheatCode.Authentication.IdServer4.MvcApp.AuthorizationRequirements;
...
namespace CheatCode.Authentication.IdServer4.MvcApp
{
    public static class ProgramExtensions
    {
        ...
        public static void AddCheatCodeAuthentication(this IServiceCollection services)
        {
            services.AddAuthentication(options =>
                {
                    options.DefaultScheme = SharedValues.IdServer4.CookiesScheme;
                ...
                .AddCookie(SharedValues.IdServer4.CookiesScheme, options =>
                {
                ...
                .AddJwtBearer("jwt", options => {
                    ...
                    {
                        ValidIssuer = SharedValues.IdServer4.Issuer,
                        ValidAudience = SharedValues.IdServer4.Audience,
                ...
                .AddOpenIdConnect(SharedValues.IdServer4.OpenIdConnectScheme, options =>
                {
                    ...
                    options.SignInScheme = SharedValues.IdServer4.CookiesScheme;

                    options.ClientId = SharedValues.IdServer4.MvcClientId;
                    options.ClientSecret = SharedValues.IdServer4.MvcClientSecret;
                    ...
                    options.Scope.Add(SharedValues.IdServer4.OfficeResouceName);
                    options.Scope.Add(SharedValues.IdServer4.Api1Scope);
                    options.Scope.Add(SharedValues.IdServer4.CheatCodeApiReadScope);
                    ...
                    options.ClaimActions.MapUniqueJsonKey("UserId", SharedValues.IdServer4.UserIdClaim);
                    options.ClaimActions.MapUniqueJsonKey("MyUserEmail", SharedValues.IdServer4.UserEmailClaim);
                });
        }
